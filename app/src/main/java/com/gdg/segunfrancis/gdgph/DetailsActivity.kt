...
import com.gdg.segunfrancis.gdgph.utility.MethodUtils.Companion.updateSignInText
...
class DetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        displayName = headerView.findViewById(
            R.id.display_name
        )
        emailAddress = headerView.findViewById(
            R.id.email_address
        )
        profileImage = headerView.findViewById(
            R.id.profile_image
        )
        loginButton = headerView.findViewById(
            R.id.logout_button
        )
