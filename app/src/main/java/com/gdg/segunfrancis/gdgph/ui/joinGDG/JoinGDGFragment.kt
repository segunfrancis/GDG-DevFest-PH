package com.gdg.segunfrancis.gdgph.ui.joinGDG
...
import com.gdg.segunfrancis.gdgph.utility.MethodUtils.Companion.scaleAnimator
...
class JoinGDGFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val gdgCloudButton: MaterialButton = root.findViewById(R.id.button_cloud_meetup)
        ...
        val gdgCloudUrl = "https://www.meetup.com/Google-Developer-Group-Cloud-Port-Harcourt/"
        ...
        gdgCloudButton.setOnClickListener {
            val builder = CustomTabsIntent.Builder()
            builder.setToolbarColor(resources.getColor(R.color.colorPrimary))
            builder.setStartAnimations(root.context, R.anim.slide_in_right, R.anim.slide_out_left)
            builder.setExitAnimations(root.context, R.anim.slide_in_left, R.anim.slide_out_right)
            val customTabsIntent = builder.build()
            customTabsIntent.launchUrl(root.context, Uri.parse(gdgCloudUrl))
        }
